# UC OBS Remote Plugin

## Introduction

This plugin is intended to allow PreSonus Universal Control to remotely control instances of OBS.

Build pipeline is derived from https://github.com/obsproject/obs-plugintemplate :
